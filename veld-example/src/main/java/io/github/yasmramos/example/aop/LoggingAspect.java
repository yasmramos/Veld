 ...
 */
package io.github.yasmramos.example.aop;

import io.github.yasmramos.annotation.After;
import io.github.yasmramos.annotation.AfterType;
import io.github.yasmramos.annotation.Around;
import io.github.yasmramos.annotation.Aspect;
import io.github.yasmramos.annotation.Before;
import io.github.yasmramos.aop.InvocationContext;
import io.github.yasmramos.aop.JoinPoint;
...
public class LoggingAspect {
     ...
     */
    @Around("execution(* io.github.yasmramos.example.aop.CalculatorService.*(..))")
     ...
     */
    @Before("execution(* io.github.yasmramos.example.aop.ProductService.*(..))")
     ...
     */
    @After(value = "execution(* io.github.yasmramos.example.aop.ProductService.*(..))", 
