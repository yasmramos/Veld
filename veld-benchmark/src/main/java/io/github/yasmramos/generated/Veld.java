package io.github.yasmramos.generated;
...
public final class Veld {
    ...
    public static <T> T get(Class<T> type) {
        ...
        if (type == VeldLogger.class || type == io.github.yasmramos.benchmark.common.Logger.class) {
            return (T) _veldLogger;
        }
        if (type == VeldSimpleService.class || type == io.github.yasmramos.benchmark.common.Service.class) {
