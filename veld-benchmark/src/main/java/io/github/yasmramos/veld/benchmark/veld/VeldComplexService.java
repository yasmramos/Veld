...
public class VeldComplexService implements Service {
    ...
    private final VeldRepository repository;
    private final VeldLogger logger;
    private final VeldValidator validator;

    @Inject
    public VeldComplexService(VeldRepository repository, VeldLogger logger, VeldValidator validator) {
