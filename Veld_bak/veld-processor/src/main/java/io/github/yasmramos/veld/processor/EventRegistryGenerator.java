...
public class EventRegistryGenerator {
    ...
    public JavaFile generate() {
        ...
        TypeSpec.Builder classBuilder = TypeSpec.classBuilder(className)
                ...
                .addSuperinterface(ClassName.get("io.github.yasmramos.veld.runtime.event", "EventRegistrationSPI"))
                .addJavadoc(
        ...
        for (Map.Entry<String, List<SubscriptionInfo>> entry : byComponent.entrySet()) {
            ...
            String typedVarName = "typed" + componentIndex++;
            ...
            registerEventsMethod.addComment("Subscriptions for $N", simpleName)
                    ...
                    .addStatement("$T $N = ($T) component", ClassName.bestGuess(componentClass), typedVarName, ClassName.bestGuess(componentClass));
            ...
            for (SubscriptionInfo sub : componentSubs) {
                ...
                registration.append("bus.registerEventHandler(")
                        ...
                        .append("($T event) -> $N.").append(sub.methodName).append("(event)");
                ...
                registerEventsMethod.addStatement(registration.toString(), ClassName.bestGuess(sub.eventTypeName), typedVarName);
            }
