...
public final class ComponentFactorySourceGenerator {
    ...
    public JavaFile generate() {
        ...
        MethodSpec getComponentTypeMethod = MethodSpec.methodBuilder("getComponentType")
                ...
                .addModifiers(Modifier.PUBLIC)
                .returns(ParameterizedTypeName.get(ClassName.get(Class.class), componentType))
    ...
    private String generateDependencyGetExpression(InjectionPoint.Dependency dep) {
        ...
        if (dep.isProvider()) {
            ...
            return "io.github.yasmramos.veld.Veld.getProvider(" + dep.getActualTypeName() + ".class)";
        } else if (dep.isOptionalWrapper()) {
            // Optional<T> injection - use Veld.getOptional()
            return "io.github.yasmramos.veld.Veld.getOptional(" + dep.getActualTypeName() + ".class)";
        } else {
            // Regular injection
            return "io.github.yasmramos.veld.Veld.get(" + dep.getTypeName() + ".class)";
        }
    }
