...
class ComponentFactoryTest {
    ...
    class DefaultGetScopeIdTests {
        ...
        void testDefaultGetScopeId_prototype() {
            ComponentFactory<String> factory = new TestComponentFactoryWithoutScopeId(
                0, "test", String.class, LegacyScope.PROTOTYPE
            );
    ...
    static class TestComponentFactoryWithoutScopeId<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutScopeId(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutIsLazy<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutIsLazy(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutConditionEvaluator<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutConditionEvaluator(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutImplementedInterfaces<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutImplementedInterfaces(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutPrimary<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutPrimary(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutOrder<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutOrder(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutQualifier<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutQualifier(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutFactoryClass<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutFactoryClass(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutBeanMethodName<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutBeanMethodName(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutFactoryMethodParameters<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutFactoryMethodParameters(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutDestructionDependencies<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutDestructionDependencies(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutDestroyOrder<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutDestroyOrder(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
    ...
    static class TestComponentFactoryWithoutDependencyTypes<T> implements ComponentFactory<T> {
        ...
        TestComponentFactoryWithoutDependencyTypes(int index, String name, Class<T> type, LegacyScope scope) {
            this.index = index;
            this.name = name;
            this.type = type;
            this.scope = scope;
