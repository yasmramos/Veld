...
class VeldProcessorTest {
    ...
    class SupportedAnnotationsTests {
        ...
        void shouldSupportComponentAnnotation() {
            ...
            assertTrue(supported.contains("io.github.yasmramos.annotation.Component"), 
        ...
        void shouldSupportSingletonAnnotation() {
            ...
            Set<String> supported = new HashSet<>(Arrays.asList(annotation.value()));
            assertTrue(supported.contains("io.github.yasmramos.annotation.Singleton"), 
        ...
        void shouldSupportPrototypeAnnotation() {
            ...
            Set<String> supported = new HashSet<>(Arrays.asList(annotation.value()));
            assertTrue(supported.contains("io.github.yasmramos.annotation.Prototype"), 
        ...
        void shouldSupportLazyAnnotation() {
            ...
            Set<String> supported = new HashSet<>(Arrays.asList(annotation.value()));
            assertTrue(supported.contains("io.github.yasmramos.annotation.Lazy"), 
                "Should support @Lazy");
        }
        ...
        @Test
        @DisplayName("should support exactly 6 component annotations")
        void shouldSupportExactlySixComponentAnnotations() {
            SupportedAnnotationTypes annotation = VeldProcessor.class.getAnnotation(SupportedAnnotationTypes.class);
            assertNotNull(annotation);
            
            assertEquals(6, annotation.value().length, 
                "Should support exactly 6 component annotations");
        }
    }
    ...
    class ProcessorMethodsTests {
        ...
        void getSupportedAnnotationTypesShouldReturnExpectedAnnotations() {
            ...
            assertTrue(supportedTypes.contains("io.github.yasmramos.annotation.Component"));
            assertTrue(supportedTypes.contains("io.github.yasmramos.annotation.Singleton"));
            assertTrue(supportedTypes.contains("io.github.yasmramos.annotation.Prototype"));
            assertTrue(supportedTypes.contains("io.github.yasmramos.annotation.Lazy"));
    ...
    class AnnotationCompatibilityTests {
        ...
        void shouldSupportAllVeldNativeAnnotations() {
            ...
            assertTrue(supported.stream().anyMatch(s -> s.startsWith("io.github.yasmramos.annotation.")),
    ...
    class AnnotationTypeCoverageTests {
        ...
        void shouldCoverSingletonScopeViaMultipleAnnotations() {
            ...
            assertTrue(supported.contains("io.github.yasmramos.annotation.Singleton"));
            assertTrue(supported.contains("io.github.yasmramos.annotation.Lazy")); // Lazy implies Singleton
            assertTrue(supported.contains("javax.inject.Singleton"));
            assertTrue(supported.contains("jakarta.inject.Singleton"));
        }
