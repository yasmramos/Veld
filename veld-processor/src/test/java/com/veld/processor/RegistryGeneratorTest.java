...
class RegistryGeneratorTest {
    ...
    class BasicRegistryGenerationTests {
        ...
        void shouldGenerateRegistryWithCorrectClassName() {
            ...
            assertEquals("com/veld/generated/VeldRegistry", cn.name);
        }
        ...
        void shouldReturnCorrectClassName() {
            ...
            assertEquals("com.veld.generated.VeldRegistry", generator.getRegistryClassName());
        }
        ...
        void shouldReturnCorrectInternalName() {
            ...
            assertEquals("com/veld/generated/VeldRegistry", generator.getRegistryInternalName());
        }
    }
