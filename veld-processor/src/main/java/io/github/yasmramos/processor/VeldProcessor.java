...
import io.github.yasmramos.annotation.*;
import io.github.yasmramos.processor.AnnotationHelper.InjectSource;
 ...
 * - @io.github.yasmramos.annotation.Component (Veld native - requires scope annotation)
 * - @io.github.yasmramos.annotation.Singleton (Veld native - singleton scope, implies @Component)
 * - @io.github.yasmramos.annotation.Prototype (Veld native - prototype scope, implies @Component)
 * - @io.github.yasmramos.annotation.Lazy (Veld native - lazy singleton, implies @Component)
 ...
 * - @io.github.yasmramos.annotation.Inject (Veld native)
 * - @javax.inject.Inject (JSR-330)
 * - @jakarta.inject.Inject (Jakarta EE)
 * 
 * Supported Qualifier Annotations:
 * - @io.github.yasmramos.annotation.Named (Veld native)
 * - @javax.inject.Named (JSR-330)
 * - @jakarta.inject.Named (Jakarta EE)
 */
@SupportedAnnotationTypes({
    "io.github.yasmramos.annotation.Component",
    "io.github.yasmramos.annotation.Singleton",
    "io.github.yasmramos.annotation.Prototype",
    "io.github.yasmramos.annotation.Lazy",
...
public class VeldProcessor extends AbstractProcessor {
    ...
    private Dependency createDependency(VariableElement element) {
        ...
        boolean isOptional = element.getAnnotation(io.github.yasmramos.annotation.Optional.class) != null;
        if (isOptional) {
    ...
    private ProviderInfo checkForProvider(TypeMirror typeMirror) {
        ...
        boolean isProvider = 
            "io.github.yasmramos.runtime.Provider".equals(providerTypeName) ||
    ...
    private void analyzeEventSubscribers(TypeElement typeElement, ComponentInfo info) {
        TypeElement subscribeAnnotation = elementUtils.getTypeElement("io.github.yasmramos.annotation.Subscribe");
        ...
        for (Element enclosed : typeElement.getEnclosedElements()) {
            ...
            for (AnnotationMirror annotation : method.getAnnotationMirrors()) {
                ...
                if (annotationName.equals("io.github.yasmramos.annotation.Subscribe")) {
