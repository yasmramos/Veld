 ...
 * - Veld native annotations (io.github.yasmramos.annotation.*)
...
public final class AnnotationHelper {
    ...
    private static final String VELD_INJECT = "io.github.yasmramos.annotation.Inject";
    private static final String VELD_NAMED = "io.github.yasmramos.annotation.Named";
    private static final String VELD_SINGLETON = "io.github.yasmramos.annotation.Singleton";
    ...
    public static Optional<String> getQualifierValue(Element element) {
        ...
        for (AnnotationMirror annotationMirror : element.getAnnotationMirrors()) {
            ...
            if (annotationType.startsWith("java.") || 
                ...
                annotationType.startsWith("io.github.yasmramos.annotation.") ||
    ...
    public enum InjectSource {
        VELD("io.github.yasmramos.annotation"),
        JAVAX("javax.inject"),
