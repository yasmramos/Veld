...
public class VeldAnnotationProcessor extends AbstractProcessor {
    ...
    private void generateSubscriberRegistry(List<AnnotatedMethod> subscribers) {
        ...
        builder.append("package io.github.yasmramos.veld.processor.generated.internal;\n\n");
        builder.append("import io.github.yasmramos.veld.processor.generated.event.*;\n");
        builder.append("import io.github.yasmramos.veld.processor.generated.lifecycle.*;\n\n");
        builder.append("/**\n");
        ...
        try {
            JavaFileObject file = processingEnv.getFiler()
                .createSourceFile("io.github.yasmramos.veld.processor.generated.internal.VeldSubscriberRegistry");
    ...
    private void generateLifecycleRegistry(List<AnnotatedMethod> callbacks) {
        ...
        try {
            JavaFileObject file = processingEnv.getFiler()
                .createSourceFile("io.github.yasmramos.veld.processor.generated.internal.VeldLifecycleRegistry");
            try (PrintWriter out = new PrintWriter(file.openWriter())) {
                out.print(builder.toString());
            }
        } catch (IOException e) {
