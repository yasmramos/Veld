...
public final class ComponentFactoryGenerator {
    ...
    private static final String CONDITION_CONTEXT = "io/github/yasmramos/runtime/condition/ConditionContext";
    private static final String CONDITION_EVALUATOR = "io/github/yasmramos/runtime/condition/ConditionEvaluator";
    private static final String VALUE_RESOLVER = "io/github/yasmramos/runtime/value/ValueResolver";
