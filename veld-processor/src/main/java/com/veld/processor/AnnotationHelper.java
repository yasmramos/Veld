 ...
 * - Veld native annotations (com.veld.annotation.*)
...
public final class AnnotationHelper {
    ...
    private static final String VELD_INJECT = "com.veld.annotation.Inject";
    private static final String VELD_NAMED = "com.veld.annotation.Named";
    private static final String VELD_SINGLETON = "com.veld.annotation.Singleton";
    ...
    public static Optional<String> getQualifierValue(Element element) {
        ...
        for (AnnotationMirror annotationMirror : element.getAnnotationMirrors()) {
            ...
            if (annotationType.startsWith("java.") || 
                ...
                annotationType.startsWith("com.veld.annotation.") ||
