...
echo "🔧 COMPILACIÓN MANUAL CORREGIDA DE VELD"
echo "========================================"
echo ""
...
cd $ANNOTATIONS_SRC
javac -d $BUILD_DIR/veld-annotations io/github/yasmramos/annotation/*.java
...
# Compilar runtime con classpath correcto
echo ""
echo "🔧 Compilando veld-runtime..."
cd $RUNTIME_SRC
javac -d $BUILD_DIR/veld-runtime -cp $BUILD_DIR/veld-annotations $(find . -name "*.java" ! -name "module-info.java")
